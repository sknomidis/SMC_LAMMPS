...
shift = rDNA[attachment] - rSiteD[1] - np.array([0,1,0]) * sigmaSiteDvsDNA * 2**(1/6)
...
datafile.write("%s 5 %s %s\n\n" %(nDNA+14,  IDhK[nHK//2], IDdNA[attachment-loop]))
